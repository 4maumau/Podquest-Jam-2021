...
public class VerticalScroll : MonoBehaviour
{
    ...
    void repositionChildObjects(GameObject obj)
    {
        ...
        if (children.Length > 1)
        {
            ...
            if (transform.position.y + screenBounds.y > lastChild.transform.position.y + halfObjectHeight)
            {
                ...
                firstChild.transform.position = new Vector3(lastChild.transform.position.y, lastChild.transform.position.y + halfObjectHeight * 2,  lastChild.transform.position.z);
            }
    ...
    void Update()
    {
        playerAnimator.Play("PlayerJumpDown");
